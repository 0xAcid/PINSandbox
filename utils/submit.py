...
import random
import sys
from ParserPIN import PINParser
import select
from Entropy import FileEntropy
try:
    import requests
    HAVE_REQUESTS = True
except ImportError:
...
def main():
    ...
    parser.add_argument("--PIN", help="\033[91mForce PINDemonium \o/ \033[0m", action='store_true', required=False)
